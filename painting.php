...
<head>
    <meta charset="UTF-8">
    <title>Paint Services in <?php echo htmlspecialchars(ucfirst($city)); ?></title>
    <link rel="stylesheet" href="bootstrap-5.0.2-dist/css/bootstrap.min.css">
</head>
<body>
<div class="container mt-4">
    <h2>Paint Services in <?php echo htmlspecialchars(ucfirst($city)); ?></h2>
    ...
    <?php if ($city): ?>
        <?php
        $sql = "SELECT id, username, contact, city FROM serviceprovider WHERE city = ? AND service = 'Painting'";
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p>No paint service providers found in " . htmlspecialchars(ucfirst($city)) . ".</p>";
        }
        $stmt->close();
        ?>
    <?php else: ?>
        <p>Please select a city from the <a href="paint.html">search page</a>.</p>
    <?php endif; ?>
</div>
</body>
</html>
