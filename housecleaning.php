...
<head>
    <meta charset="UTF-8">
    <title>Housecleaning Services in <?php echo htmlspecialchars(ucfirst($city)); ?></title>
    <link rel="stylesheet" href="bootstrap-5.0.2-dist/css/bootstrap.min.css">
</head>
<body>
<div class="container mt-4">
    <h2>Housecleaning Services in <?php echo htmlspecialchars(ucfirst($city)); ?></h2>
    ...
    <?php if ($city): ?>
        <?php
        $sql = "SELECT id, username, contact, city FROM serviceprovider WHERE city = ? AND service = 'Housecleaning'";
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p>No housecleaning service providers found in " . htmlspecialchars(ucfirst($city)) . ".</p>";
        }
        $stmt->close();
        ?>
    <?php else: ?>
        <p>Please select a city from the <a href="housecleaning.html">search page</a>.</p>
    <?php endif; ?>
</div>
</body>
</html>
