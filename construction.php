...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['provider_id'], $_POST['city'])) {
    ...
    if ($stmt->execute()) {
        $message = "Construction service booked successfully!";
    } else {
...
<head>
    ...
    <title>Construction Services in <?php echo htmlspecialchars(ucfirst($city)); ?></title>
    <link rel="stylesheet" href="bootstrap-5.0.2-dist/css/bootstrap.min.css" />
</head>
<body>
<div class="container mt-4">
    <h2>Construction Services in <?php echo htmlspecialchars(ucfirst($city)); ?></h2>
    ...
    <?php if ($city): ?>
        ...
        $sql = "SELECT id, username, contact, city 
                ...
                WHERE city = ? AND service = 'construction'";
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p>No construction service providers found in " . htmlspecialchars(ucfirst($city)) . ".</p>";
        }
        $stmt->close();
        ?>
    <?php else: ?>
        <p>Please select a city from the <a href="construction.html">search page</a>.</p>
    <?php endif; ?>
